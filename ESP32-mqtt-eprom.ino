/* ---------------------------------------------------------------
Include require libraries to handle WIFI , MQTT and EEPROM functions
...
Serial.println("MQTT Data Ready to published");
client.publish(MQTT_TOPIC_1, String(sensorValue_1),true,1);
delay(1000);
